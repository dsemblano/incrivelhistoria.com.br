...
<div id="skeleton-loading" class="flex flex-col gap-5 h-76 w-4/5 sm:w-1/2 mx-auto my-2 bg-white shadow-lg select-none sm:p-4 sm:h-70 rounded-2xl sm:flex-row ">
