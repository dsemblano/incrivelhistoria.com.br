...
<?php
echo '<div class="gap-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mt-5 w-full lg:pr-8 mb-6">';
...
<article>
    ...
    <?php echo '<h2 class="category-name font-bold mb-4 text-ihcat leading-8">'.'<a href="'.$get_term_link.'">'.$term_name.'</a>'.'</h2>';?>
    {{-- <span>Aqui: {{ $term->count }}</span> --}}
    <a href={{$get_term_link}}>
        <figure class="imgpost h-36">
            <img src="{{ get_taxonomy_image($term_id) }}" width="350" height="155"
                alt="Imagem da categoria {{$term_name}}" class="w-full shadow-xl rounded-t-md wp-post-image">
        </figure>
    </a>
