<section {{ $attributes }}>
  ...
  <div class="flex flex-col">
    ...
    <div class="top flex flex-col lg:flex-row mb-6">
      <article class="flex flex-col lg:flex-row card">

        <div class="left w-full lg:w-2/3 h-full">
          <a href="{{ get_permalink() }}">
            <figure class="imgpost">
              {{ the_post_thumbnail('mais_extendida', array( 'class' => 'w-full h-full rounded-t-md xl:rounded-tr-none
              rounded-tl-md' ) ) }}
            </figure>
          </a>
        </div>
...
<div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 mt-6 mb-8">
  ...
  <section id="direitos-humanos" class="">
    ...
    {{-- @php echo $first_loop; @endphp --}}
    @if ($first_loop)
    <article class="border-default pb-8 mb-8 rounded hover:rounded h-97">
      <a href="{{ get_permalink() }}">
        <figure class="imgpost">
          {{ the_post_thumbnail('mais_extendida', array( 'class' => 'w-full shadow-xl rounded-t-md' ) ) }}
        </figure>
...
<div class="flex items-center justify-center mb-4">
  <button
    class="vermais bg-ihcat hover:bg-ihcat text-xl shadow-xl text-white py-2 px-4 rounded button transform hover:scale-110 transition duration-300 ease-in-out">
